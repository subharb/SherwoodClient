...
export const BUSINESS_MANAGER = [ MEDICAL_READ, PERSONAL_ACCESS, BUSINESS_READ, SHARE_RESEARCHERS ];
export const BUSINESS_ASSISTANT = [ BUSINESS_READ ];
export const LAB_MANAGER = [MEDICAL_WRITE, MEDICAL_READ, SHARE_RESEARCHERS ];
export const LAB_ASSISTANT = [MEDICAL_READ];
export const ALL_ROLES = {"SHERWOOD_STAFF" : SHERWOOD_STAFF, "MEDICAL_DIRECTOR" : MEDICAL_DIRECTOR, "DOCTOR" : DOCTOR, "BUSINESS_MANAGER" : BUSINESS_MANAGER, "BUSINESS_ASSISTANT" : BUSINESS_ASSISTANT, "LAB_MANAGER" : LAB_MANAGER, "LAB_ASSISTANT" : LAB_ASSISTANT}
export const ROLES = {"MEDICAL_DIRECTOR" : MEDICAL_DIRECTOR, "DOCTOR" : DOCTOR, "BUSINESS_MANAGER" : BUSINESS_MANAGER, "BUSINESS_ASSISTANT" : BUSINESS_ASSISTANT, "LAB_MANAGER" : LAB_MANAGER, "LAB_ASSISTANT" : LAB_ASSISTANT}