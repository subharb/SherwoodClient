...
export const CATEGORY_SURVEYS = [{ value: CATEGORY_SURVEY_MEDICAL, name: "Medical" }, { value: CATEGORY_SURVEY_SOCIAL, name: "Social", url: "social" }, { value: CATEGORY_SURVEY_SHOE, name: "Shoe", url: "shoe" }];
...
export const DOCTOR = [PERMISSION.MEDICAL_WRITE, PERMISSION.MEDICAL_READ, PERMISSION.PERSONAL_ACCESS,  PERMISSION.EDIT_SUBMISSIONS];
export const DEPARTMENT_HEAD = [PERMISSION.MEDICAL_WRITE, PERMISSION.MEDICAL_READ, PERMISSION.PERSONAL_ACCESS,  PERMISSION.EDIT_SUBMISSIONS, PERMISSION.ANALYTICS_DEPARTMENT];
