...
//Roles
export const MEDICAL_DIRECTOR = [PERMISSION.MEDICAL_WRITE, PERMISSION.MEDICAL_READ, PERMISSION.PERSONAL_ACCESS, PERMISSION.BUSINESS_READ, PERMISSION.SHARE_RESEARCHERS, PERMISSION.MAKE_DISCOUNTS ];
...
export const PHARMACY_MANAGER = [PERMISSION.MEDICAL_WRITE, PERMISSION.MEDICAL_READ, PERMISSION.PERSONAL_ACCESS, PERMISSION.MANAGE_PHARMACY_CENTRAL, PERMISSION.UPDATE_PHARMACY_CENTRAL];
export const PHARMACY_ASSISTANT = [PERMISSION.MEDICAL_WRITE, PERMISSION.MEDICAL_READ, PERMISSION.PERSONAL_ACCESS, PERMISSION.UPDATE_PHARMACY_CENTRAL];
