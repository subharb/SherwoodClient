...
export const NURSE_MANAGER = [PERMISSION.MEDICAL_READ, PERMISSION.PERSONAL_ACCESS,  PERMISSION.EDIT_SUBMISSIONS, PERMISSION.CREATE_APPOINTMENTS, PERMISSION.CANCEL_APPOINTMENTS, PERMISSION.VISUALIZE_APPOINTMENTS, PERMISSION.VIEW_HOSPITALIZATION, PERMISSION.CARE_GIVER, PERMISSION.NURSE_FW];
