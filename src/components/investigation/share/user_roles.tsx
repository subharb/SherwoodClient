...
export const ADMIN_FW = [PERMISSION.MEDICAL_READ, PERMISSION.PERSONAL_ACCESS, PERMISSION.SHARE_RESEARCHERS, PERMISSION.CREATE_APPOINTMENTS, PERMISSION.CANCEL_APPOINTMENTS, PERMISSION.VISUALIZE_APPOINTMENTS, PERMISSION.EDIT_HOSPITALIZATION, PERMISSION.VIEW_HOSPITALIZATION];
export const NURSE = [PERMISSION.MEDICAL_WRITE, PERMISSION.MEDICAL_READ, PERMISSION.PERSONAL_ACCESS, PERMISSION.VIEW_HOSPITALIZATION,];
export const NURSE_FW = [PERMISSION.MEDICAL_WRITE, PERMISSION.PERSONAL_ACCESS, PERMISSION.CARE_GIVER, PERMISSION.NURSE_FW, PERMISSION.VIEW_HOSPITALIZATION,];
...
export const CARE_GIVER = [PERMISSION.MEDICAL_WRITE, PERMISSION.PERSONAL_ACCESS, PERMISSION.CARE_GIVER, PERMISSION.VIEW_HOSPITALIZATION,];
