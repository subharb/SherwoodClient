...
export const NURSE_FW = [PERMISSION.MEDICAL_WRITE, PERMISSION.PERSONAL_ACCESS, PERMISSION.CARE_GIVER, PERMISSION.NURSE_FW];
export const NURSE_MANAGER = [PERMISSION.MEDICAL_READ, PERMISSION.PERSONAL_ACCESS,  PERMISSION.EDIT_SUBMISSIONS, PERMISSION.CREATE_APPOINTMENTS, PERMISSION.CANCEL_APPOINTMENTS, PERMISSION.VISUALIZE_APPOINTMENTS, PERMISSION.HOSPITALIZATION, PERMISSION.CARE_GIVER, PERMISSION.NURSE_FW];
export const CARE_GIVER = [PERMISSION.MEDICAL_WRITE, PERMISSION.PERSONAL_ACCESS, PERMISSION.CARE_GIVER];
...
export const USER_ROLES = { "PRIVATE_DOCTOR": PRIVATE_DOCTOR, "NURSE": NURSE, "NURSE_FW" : NURSE_FW, "NURSE_MANAGER" : NURSE_MANAGER, "CARE_GIVER" : CARE_GIVER, "ADMIN": ADMIN, "STUDENT": STUDENT, 
                            ...
                            "PHARMACY_ASSISTANT": PHARMACY_ASSISTANT, "MAJOR": MAJOR, "DEPARTMENT_HEAD" : DEPARTMENT_HEAD };
