...
const ShowSingleSubmissionPatient: React.FC<ShowSubmissionPatientProps> = ({ currentSurvey, forceEdit, printMode, submission, idSubmission, callBackEditSubmission }) => {
    ...
    return <ShowSingleSubmissionPatientView currentSurvey={currentSurvey} forceEdit={forceEdit} printMode={printMode} submission={submissionCached} 
...
export const ShowSingleSubmissionPatientView: React.FC<ShowSubmissionPatientProps> = ({ currentSurvey, forceEdit, printMode, callBackEditSubmission, submission }) => {
    ...
    const recordsSection = Object.values(currentSurvey!.sections).sort((a:any,b:any) => a.order - b.order).map((section:any) => {
        ...
        return(
            <ShowRecordsSection forceEdit={forceEdit} printMode={printMode}
