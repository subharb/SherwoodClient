...
interface AppointmentsDateProps{
...
export const AppointmentsDate: React.FC<AppointmentsDateProps> = ({ loadingAppointments, loadingSingleAppointment, appointments, mode, showSnackbar,
